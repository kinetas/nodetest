...
const authRoutes = require('./route/authRoutes'); // �씪�슦�듃 媛��졇�삤湲�
const missionRoutes = require('./route/missionRoutes'); // 誘몄??? �씪�슦�듃 ?��?��?���삤湲�
const roomRoutes = require('./route/roomRoutes');
const friendRoutes = require('./route/friendRoutes');
const cVoteRoutes = require('./route/cVoteRoutes');
const c_missionRoutes = require('./route/c_missionRoutes');
const resultRoutes = require('./route/resultRoutes'); // 결과 ?��?��?�� 추�??
const userInfoRoutes = require('./route/userInfoRoutes');
const recommendationMissionRoutes = require('./route/recommendationMissionRoutes'); // 라우트 파일 가져오기
