...
const chatRoutes = require('./routesx/chatRoutes');
const authRoutes = require('./routesx/authRoutes'); // �씪�슦�듃 媛��졇�삤湲�
const missionRoutes = require('./routesx/missionRoutes'); // 誘몄??? �씪�슦�듃 ?��?��?���삤湲�
const roomRoutes = require('./routesx/roomRoutes');
const friendRoutes = require('./routesx/friendRoutes');
const cVoteRoutes = require('./routesx/cVoteRoutes');
const c_missionRoutes = require('./routesx/c_missionRoutes');
const resultRoutes = require('./routesx/resultRoutes'); // 결과 ?��?��?�� 추�??
const userInfoRoutes = require('./routesx/userInfoRoutes');
const recommendationMissionRoutes = require('./routesx/recommendationMissionRoutes'); // 라우트 파일 가져오기
