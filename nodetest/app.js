...
//================================keycloak================================
// ✅ app.js - Keycloak 기반으로 인증 흐름 전환된 버전
const express = require('express');
...
app.get('/findinfo', (req, res) => res.sendFile(path.join(__dirname, 'public', 'findinfo.html')));

// ✅ API 라우터 연결 (Keycloak 보호 적용)
app.use('/api/auth', authRoutes);
app.use('/dashboard', keycloak.protect(), missionRoutes);
app.use('/api/rooms', keycloak.protect(), roomRoutes);
app.use('/api/cVote', keycloak.protect(), cVoteRoutes);
app.use('/api/comumunity_missions', keycloak.protect(), c_missionRoutes);
app.use('/result', keycloak.protect(), resultRoutes);
app.use('/api/user-info', keycloak.protect(), userInfoRoutes);
app.use('/dashboard/friends', keycloak.protect(), friendRoutes);
app.use('/api/ai', keycloak.protect(), aiRoutes);
app.use('/api/recommendationMission', keycloak.protect(), recommendationMissionRoutes);
